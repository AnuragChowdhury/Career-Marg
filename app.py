...
<div style="margin-top: 1.5rem; margin-bottom: 2rem; background: #FFFFFF; border: 1px solid #E2E8F0; border-left: 5px solid #FF5C00; border-radius: 16px; padding: 1.2rem 1.4rem; box-shadow: 0 8px 25px rgba(15, 23, 42, 0.05);">
  <div style="display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 1rem;">
    <div style="flex: 1; min-width: 240px;">
      <span style="font-size: 0.72rem; font-weight: 800; text-transform: uppercase; color: #FF5C00; letter-spacing: 0.8px;">📖 Featured Engineering Story</span>
      <h4 style="margin: 0.3rem 0 0.3rem 0; font-size: 1.02rem; font-weight: 800; color: #0F172A;">Apne Career Ko Do Raasta: Engineering Career मार्ग</h4>
      <p style="margin: 0; font-size: 0.83rem; color: #64748B; line-height: 1.45;">Discover how we architected multimodal OCR pipelines, 5-factor ATS algorithms, and real-time interactive mock interview engines.</p>
    </div>
    <div>
      <a href="https://medium.com/@anuragchowdhury19official/building-career-%E0%A4%AE%E0%A4%BE%E0%A4%B0%E0%A5%8D%E0%A4%97-how-i-built-an-executive-multimodal-ai-career-preparation-intelligence-2e85b983ebbd" target="_blank" style="display: inline-flex; align-items: center; gap: 6px; background: linear-gradient(135deg, #FF5C00 0%, #D43F00 100%); color: #FFFFFF !important; text-decoration: none !important; padding: 0.65rem 1.35rem; border-radius: 30px; font-weight: 700; font-size: 0.88rem; box-shadow: 0 4px 14px rgba(255, 92, 0, 0.28); white-space: nowrap; transition: all 0.2s ease;">
        <span style="color: #FFFFFF !important; text-decoration: none !important;">Read on Medium &rarr;</span>
      </a>
    </div>
  </div>
</div>
