...
<div style="display: flex; align-items: center; gap: 14px; flex-wrap: wrap; margin-top: 1.6rem; margin-bottom: 2rem;">
  <a href="/Resume_Analysis" target="_self" class="medium-btn" style="display: inline-flex; align-items: center; justify-content: center; gap: 8px; background: linear-gradient(135deg, #FF5C00 0%, #D43F00 100%); color: #FFFFFF !important; text-decoration: none !important; padding: 0.75rem 1.8rem; border-radius: 30px; font-weight: 700; font-size: 0.95rem; box-shadow: 0 5px 16px rgba(255, 92, 0, 0.35); transition: all 0.25s ease;">
    <span style="color: #FFFFFF !important; text-decoration: none !important; font-weight: 700;">🚀 Launch Platform OS &rarr;</span>
  </a>
  <a href="https://medium.com/@anuragchowdhury19official/building-career-%E0%A4%AE%E0%A4%BE%E0%A4%B0%E0%A5%8D%E0%A4%97-how-i-built-an-executive-multimodal-ai-career-preparation-intelligence-2e85b983ebbd" target="_blank" class="medium-btn" style="display: inline-flex; align-items: center; justify-content: center; gap: 8px; background: linear-gradient(135deg, #FF5C00 0%, #D43F00 100%); color: #FFFFFF !important; text-decoration: none !important; padding: 0.75rem 1.8rem; border-radius: 30px; font-weight: 700; font-size: 0.95rem; box-shadow: 0 5px 16px rgba(255, 92, 0, 0.35); transition: all 0.25s ease;">
    <span style="color: #FFFFFF !important; text-decoration: none !important; font-weight: 700;">📖 Read Story on Medium &#8599;</span>
  </a>
</div>
</div>
